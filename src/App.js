      ...
      <form className="w-5/6 max-w-xl mx-auto pt-4 pb-10">
        ...
        <fieldset className="flex flex-col gap-2 border py-1 px-4">
          ...
          <div key={prompt.timestamp} className="flex flex-col">
            ...
            <select  className="w-3/5 border rounded text-lg leading-tight py-3 px-2 mt-4 mb-3 focus:outline-indigo-200"
              ...
              <option value="We're the same type of weird if...">We're the same type of weired if...</option>
            </select>
            <button
